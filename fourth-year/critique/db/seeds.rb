# default admin
User.create!(name: 'ADMIN', email: 'admin@critique.com', password: 12_345_678, gender: 'Male', role: 'admin' , birth_date: Date.new(1994, 1, 1), country: 'PT')
# default moderator
User.create!(name: 'MODERATOR 1', email: 'moderator@critique.com', password: 12_345_678, gender: 'Male', role: 'moderator', birth_date: Date.new(1994, 1, 1), country: 'PT')

##### Albums

Album.create!(name: 'The Life of Pablo', importance: 50, description: 'The Life of Pablo is the seventh studio album by American rapper Kanye West. It was released on February 14, 2016, by Roc-A-Fella Records, GOOD Music and Def Jam Recordings.',
...
Game.create!(name: 'The Witcher 3: Wild Hunt', importance: 100, description: 'The Witcher 3: Wild Hunt is a dark fantasy open-world action role-playing video game developed by CD Projekt RED.[5] Announced in February 2013, it was released worldwide for Microsoft Windows, PlayStation 4, and Xbox One on 19 May 2015. The game is the third in the series, preceded by The Witcher and The Witcher 2: Assassins of Kings, which are based on the series of fantasy novels by Polish author Andrzej Sapkowski.',
...
Movie.create!(name: '2001: Space Odissey', importance: 75, description: 'Humanity finds a mysterious, obviously artificial object buried beneath the Lunar surface and, with the intelligent computer H.A.L. 9000, sets off on a quest.',
...
Show.create!(name: 'Game of Thrones', importance: 55, description: 'While a civil war brews between several noble families in Westeros, the children of the former rulers of the land attempt to rise up to power. Meanwhile a forgotten race, bent on destruction, return after thousands of years in the North.',
